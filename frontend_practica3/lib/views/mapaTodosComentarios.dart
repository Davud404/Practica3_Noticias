...
class MapaTodosComentarios extends StatefulWidget {
  final List<dynamic> comentarios;
  const MapaTodosComentarios({Key? key, required this.comentarios}) : super(key: key);

  @override
  _MapaTodosComentariosState createState() => _MapaTodosComentariosState();
}

class _MapaTodosComentariosState extends State<MapaTodosComentarios> {
